...
SCHEMA_PATH = Path('/Users/pflorencio/resysph/backend/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/pflorencio/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    floor: 'actions.FloorActions[models.Floor]'
    table: 'actions.TableActions[models.Table]'
    member: 'actions.MemberActions[models.Member]'
    reservation: 'actions.ReservationActions[models.Reservation]'
    ...
    def __init__(
        ...
        *,
        ...
        self.floor = actions.FloorActions[models.Floor](self, models.Floor)
        self.table = actions.TableActions[models.Table](self, models.Table)
        self.member = actions.MemberActions[models.Member](self, models.Member)
        self.reservation = actions.ReservationActions[models.Reservation](self, models.Reservation)
...
class Batch:
    ...
    floor: 'FloorBatchActions'
    table: 'TableBatchActions'
    member: 'MemberBatchActions'
    reservation: 'ReservationBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.floor = FloorBatchActions(self)
        self.table = TableBatchActions(self)
        self.member = MemberBatchActions(self)
        self.reservation = ReservationBatchActions(self)
